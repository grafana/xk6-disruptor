...
func BuildHttpCmd() *cobra.Command {
	...
	cmd.Flags().DurationVarP(&duration, "duration", "d", 60*time.Second, "duration of the disruptions")
	cmd.Flags().UintVarP(&disruption.AverageDelay, "average-delay", "a", 100, "average request delay (milliseconds)")
